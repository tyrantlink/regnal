...
def _normal_embed(
	...
	embed.add_field(
		...
		value=client.helpers.handle_cmd_ref(auto_response.data.source) if auto_response.data.source else None)
	embed.add_field(
	...
	if include_statistics:
		embed.set_footer(text=f'trigger count: {auto_response.statistics.trigger_count:,}')
	return embed
