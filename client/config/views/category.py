...
class ConfigCategoryView(SubView):
    ...
    async def __ainit__(self) -> None:
        ...
        for subcategory in self.config_category.subcategories:
            ...
            options.append(SelectOption(label=subcategory.name,
        ...
        self.get_item('subcategory_select').options = [
    ...
    async def subcategory_select(self, select: Select, interaction: Interaction) -> None:
        ...
        view = self.master.create_subview(
            ConfigSubcategoryView, self.config_category, subcategory, self.user)
