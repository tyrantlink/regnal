...
class ExtensionQOTDSubCog(SubCog):
    ...
    async def find_guilds(
        self) -> AsyncIterator[tuple[Guild, GuildDocument]]: ...

    async def log_ask_custom(self, author: Member, question: str) -> None: ...

    async def get_question(
        self, guild_doc: GuildDocument) -> tuple[GuildDocument, Embed]: ...

    async def ask_qotd(self, guild: Guild,
                       guild_doc: GuildDocument) -> bool: ...
