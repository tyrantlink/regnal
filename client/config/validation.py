...
async def user_general_no_track(
    client: 'Client',
    option: ConfigOption,
    value: bool,
    user: User | Member
...
async def guild_general_timezone(
    client: 'Client',
    option: ConfigOption,
    value: str,
    user: User | Member
    ...
    try:
        ...
        raise ConfigValidationError(f'unknown timezone `{value}`')

    return zone.zone, None


async def guild_general_embed_color(
    client: 'Client',
    option: ConfigOption,
    value: str,
    user: User | Member
